...
Cada um desses cinco itens deveria começar por uma rodada de perguntas ao usuário antes de qualquer código — são decisões de produto (cobrar ou não, qual storage, qual conteúdo no relatório), não apenas técnicas.
